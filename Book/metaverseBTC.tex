...
\titlepage % Output the title page
	...
	{ % Title(s) and author(s)
		...
		{\LARGE Bitcoin, Nostr, Stablecoins, Digital\\Objects and Machine Learning\\in B2B Telepresent Mixed Reality\\}  % Subtitle
...
%\includepdf[pages=-]{mllinks.pdf}
\part{Rought research links}
\input{RD}
