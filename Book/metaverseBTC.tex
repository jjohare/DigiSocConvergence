...
\titlepage % Output the title page
	...
	{ % Title(s) and author(s)
		...
		{\LARGE Bitcoin and stablecoins in  social XR\\Draft product roadmap\par}  % Subtitle
