...
\addbibresource{metaverseBTC.bib} % Bibliography file
...
\titlepage % Output the title page
	...
	{ % Title(s) and author(s)
		...
		{\LARGE Bitcoin, Nostr, Stablecoins, Digital\\Objects and Generative AI\\in B2B Spatial Mixed Reality\\}  % Subtitle
		\vspace{24pt} % Vertical whitespace
\centering Dr John O'Hare, Dr Allen Fairchild, and James Lewis\\on behalf of flossverse ltd. \\ \bigskip \bigskip
\large\centering {---------}\par}
